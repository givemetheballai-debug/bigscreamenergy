...
export default function ChaosScreen({ userText, onReset, onNavigate, globalCount }) {
  ...
  return (
    ...
    >
      ...
      {selectedShapes.includes('lines') && (
        <>
          <motion.div 
            ...
            animate={animationSpeed === 'fast' ? {
              opacity: [0, shapeOpacity, shapeOpacity],
              scaleY: shapeAnimation === 'pulse' ? [1, 1.3, 1] : 1,
              scaleX: shapeAnimation === 'pulse' ? [1, 2.5, 1] : 1
            } : {
              opacity: shapeOpacity * 0.5
            }}
            transition={animationSpeed === 'fast' ? {
          ...
          <motion.div 
            ...
            animate={animationSpeed === 'fast' ? {
              opacity: [0, shapeOpacity, shapeOpacity],
              scaleY: shapeAnimation === 'pulse' ? [1, 1.4, 1] : 1,
      ...
      {/* Fortune - truly centered with stronger backdrop and bigger fonts */}
      <AnimatePresence>
        {fortuneFloated && (
          <motion.div
