          ...
          >
            ...
            >
              ...
              <div className="space-y-3 text-center">
                ...
                <p 
                  className="text-2xl sm:text-3xl font-semibold tracking-[0.3em] uppercase mb-2"
                  style={{ 
                ...
                <motion.p 
                  className="text-xl sm:text-2xl md:text-3xl font-semibold text-white leading-relaxed px-2 pt-2"
                  style={{ 
                    fontFamily: 'Inter, system-ui, sans-serif',
