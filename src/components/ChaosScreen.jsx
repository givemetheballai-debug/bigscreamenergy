    ...
    >
      ...
      <AnimatePresence>
        {fortuneFloated && screamCount && (
          <motion.div
            className={isDesktop 
              ? "absolute top-4 right-4 z-60 max-w-[300px]"
              : "absolute bottom-36 left-0 right-0 z-60 flex justify-center px-4"
            }
          ...
          >
            <motion.div
              className="backdrop-blur-md rounded-2xl text-white/90 text-xs sm:text-sm font-medium overflow-hidden pointer-events-auto"
              style={{
            ...
            >
              {!counterExpanded ? (
                ...
                <motion.button
                  ...
                  className="px-4 py-2 w-full text-center pointer-events-auto"
                ...
                <motion.div
                  className="px-4 py-3 flex flex-col gap-2 min-w-[280px] pointer-events-auto"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                >
                  <div className="text-center">
                  ...
                  <div className="flex gap-2 justify-center">
                    <button
                      ...
                      className="px-3 py-1 text-xs rounded-full bg-white/10 hover:bg-white/20 transition pointer-events-auto"
                    >
                      Close
                    </button>
                    <button
                      ...
                      className="px-3 py-1 text-xs rounded-full font-semibold transition pointer-events-auto"
                      style={{
