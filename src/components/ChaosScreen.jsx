...
// Function to create random shade variations
const createShadeVariation = (palette) => {
  const vary = () => Math.floor(Math.random() * 40) - 20; // -20 to +20
...
export default function ChaosScreen({ screamCount, onReset, onNavigate }) {
  ...
  // Generate falling confetti pieces with colors matching palette
  const [fallingConfetti] = useState(() => {
    const baseColors = ['#ff006e', '#06ffa5', '#ffd60a', '#04c8de', '#ff5edf', '#b5f8fe', '#fff'];
    // Add palette colors to confetti
    const colors = [...baseColors, palette[0], palette[1]];
