  ...
  return (
    ...
    >
        ...
        <>
          <motion.div 
            ...
            animate={animationSpeed === 'fast' ? {
              ...
              scale: shapeAnimation === 'pulse' ? [1, 1.3, 1] : 1,
              x: shapeAnimation === 'drift' ? [0, 30, 0] : 0
            } : {
          ...
          <motion.div 
            ...
            animate={animationSpeed === 'fast' ? {
              opacity: [0, shapeOpacity, shapeOpacity],
              scale: shapeAnimation === 'pulse' ? [1, 1.4, 1] : 1,
      ...
      {selectedShapes.includes('lines') && (
        <>
          <motion.div 
            ...
            animate={animationSpeed === 'fast' ? {
              opacity: [0, shapeOpacity, shapeOpacity],
              scaleY: shapeAnimation === 'pulse' ? [1, 1.1, 1] : 1
            } : {
              opacity: shapeOpacity * 0.5
            }}
            transition={animationSpeed === 'fast' ? {
          ...
          />
          <motion.div 
            className="absolute top-0 right-1/3 w-1 h-full" 
            style={{ backgroundColor: shapeColor }}
            initial={{ opacity: 0 }}
            animate={animationSpeed === 'fast' ? {
              opacity: [0, shapeOpacity, shapeOpacity],
              scaleY: shapeAnimation === 'pulse' ? [1, 1.15, 1] : 1
            } : {
              opacity: shapeOpacity * 0.5
            }}
            transition={animationSpeed === 'fast' ? {
              opacity: { duration: 0.5 },
              scaleY: { duration: 2.8, repeat: Infinity, ease: "easeInOut" }
            } : {
              duration: 1
            }}
          />
      ...
      {selectedShapes.includes('triangles') && (
        <motion.div 
          ...
          animate={animationSpeed === 'fast' ? {
            ...
            scale: shapeAnimation === 'pulse' ? [1, 1.2, 1] : 1
          } : {
            opacity: shapeOpacity * 0.5,
            rotate: 0,
            scale: 1
        ...
        <>
          <motion.div 
            ...
            animate={animationSpeed === 'fast' ? {
              opacity: [0, shapeOpacity, shapeOpacity],
              scale: shapeAnimation === 'pulse' ? [1, 1.3, 1] : 1,
              x: shapeAnimation === 'drift' ? [0, 20, 0] : 0
            } : {
              opacity: shapeOpacity * 0.5
            }}
            transition={animationSpeed === 'fast' ? {
          ...
          />
          <motion.div 
            className="absolute bottom-1/4 right-10 w-16 h-16 rounded-full" 
            style={{ backgroundColor: shapeColor }}
            initial={{ opacity: 0 }}
            animate={animationSpeed === 'fast' ? {
              opacity: [0, shapeOpacity, shapeOpacity],
              scale: shapeAnimation === 'pulse' ? [1, 1.25, 1] : 1,
              y: shapeAnimation === 'drift' ? [0, -25, 0] : 0
            } : {
              opacity: shapeOpacity * 0.5
            }}
            transition={animationSpeed === 'fast' ? {
      ...
      {selectedShapes.includes('starbursts') && (
        <motion.div 
          ...
          animate={animationSpeed === 'fast' ? {
            opacity: [0, shapeOpacity, shapeOpacity],
            rotate: shapeAnimation === 'rotate' ? [0, 360] : 0,
            scale: shapeAnimation === 'pulse' ? [1, 1.15, 1] : 1
          } : {
            opacity: shapeOpacity * 0.5
          }}
          transition={animationSpeed === 'fast' ? {
      ...
      {selectedShapes.includes('slashes') && (
        <>
          <motion.div 
            className="absolute top-10 right-1/3 w-40 h-1 transform rotate-45" 
            style={{ backgroundColor: shapeColor }}
            initial={{ opacity: 0 }}
            animate={animationSpeed === 'fast' ? {
              opacity: [0, shapeOpacity, shapeOpacity],
              scaleX: shapeAnimation === 'pulse' ? [1, 1.2, 1] : 1
            } : {
              opacity: shapeOpacity * 0.5
            }}
            transition={animationSpeed === 'fast' ? {
              opacity: { duration: 0.5 },
              scaleX: { duration: 2.7, repeat: Infinity, ease: "easeInOut" }
            } : {
              duration: 1
            }}
          />
          <motion.div 
            className="absolute bottom-20 left-1/4 w-32 h-1 transform -rotate-45" 
            style={{ backgroundColor: shapeColor }}
            initial={{ opacity: 0 }}
            animate={animationSpeed === 'fast' ? {
              opacity: [0, shapeOpacity, shapeOpacity],
              scaleX: shapeAnimation === 'pulse' ? [1, 1.25, 1] : 1
            } : {
              opacity: shapeOpacity * 0.5
            }}
            transition={animationSpeed === 'fast' ? {
      ...
      {/* Calming message with backdrop for readability */}
      <AnimatePresence>
        {showCalmingMessage && (
          <motion.div
          ...
          >
            <div 
              className="backdrop-blur-xl rounded-3xl px-8 py-6 text-center"
              style={{
                background: 'rgba(0, 0, 0, 0.4)',
                border: `1px solid ${palette.colors[0]}30`,
                boxShadow: `0 8px 32px rgba(0, 0, 0, 0.3), 0 0 60px ${palette.colors[0]}20`
              }}
            >
              <motion.p 
      ...
      {/* Fortune - centered on page with modern styling */}
      <AnimatePresence>
        {fortuneFloated && (
          <motion.div
            className="absolute left-1/2 top-1/2 z-70 pointer-events-none px-4"
            style={{ 
