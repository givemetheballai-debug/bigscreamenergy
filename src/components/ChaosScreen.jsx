...
export default function ChaosScreen({ screamCount, onReset, onNavigate }) {
  ...
  return (
    <>
      ...
      <motion.div
        key={currentWord}
        className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-30 max-w-screen px-4"
      ...
      >
        <h2 
          className="text-5xl sm:text-7xl md:text-9xl font-black text-white text-center break-words"
          style={{ 
