...
export default function ChaosScreen({ userText, onReset, onNavigate, globalCount, screamCount }) {
  ...
  return (
    ...
    >
      ...
      {/* Scream Counter - Expandable - Mobile: above buttons, Desktop: top right */}
      <AnimatePresence>
        {fortuneFloated && screamCount && (
          <motion.div
            className={isDesktop 
              ? "absolute top-4 right-4 z-60"
              : "absolute bottom-48 left-0 right-0 z-60 flex justify-center"
            }
          ...
          >
            <motion.div
              className="backdrop-blur-md rounded-full text-white/90 text-xs sm:text-sm font-medium overflow-hidden"
              style={{
              ...
              {!counterExpanded ? (
                ...
                >
                  ...
                  <div className="flex gap-2">
                    <button
                      onClick={() => setCounterExpanded(false)}
