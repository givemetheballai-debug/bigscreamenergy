...
function App() {
  ...
  if (view === 'ranks') {
    return <Ranks onBack={() => setView('chaos')} onNavigate={setView} onNewScream={handleNewScream} />;
  }
  ...
  if (view === 'chaos') {
    return <ChaosScreen userText={userText} onReset={handleReset} onNavigate={setView} globalCount={screamId} />;
  }
